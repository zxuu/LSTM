...
net = nn.LSTM(input_size=in_dim, hidden_size=hidden_dim, num_layers=3)
...
for i in range(epoch):
    ...
    for texts_idd, labels_idd in loader:    # 一句话
        ...
        output, (h_n, c_n) = net(input, (h0, c0))    # output:[seq_len, batch, hidden_dim] h_n:[num_layers, batch, hidden_dim] c_n:[num_layers, batch, hidden_dim]
        loss = 0
